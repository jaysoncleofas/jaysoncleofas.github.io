         ...
         <div class="row">
            <div id="carousel-example-2" class="carousel carousel-example-2 slide carousel-fade" data-ride="carousel">
               ...
               <div class="controls-top">
                  <a class="btn-floating wow fadeInLeft" data-wow-delay="0.2s" href="#carousel-example-2" data-slide="prev">
                     <i class="fa fa-chevron-left"></i>
                  </a>
                  <a class="btn-floating wow fadeInRight" data-wow-delay="0.2s" href="#carousel-example-2" data-slide="next">
                     <i class="fa fa-chevron-right"></i>
                  </a>
               </div>
               <!--Indicators-->
               <ol class="carousel-indicators wow fadeIn" data-wow-delay="0.2s">
