<!--Navbar-->
<nav class="navbar navbar-user fixed-top navbar-toggleable-md scrolling-navbar navbar-dark" style="background-color:#23242a;">
   <div class="container">
      ...
      <div class="collapse navbar-collapse" id="collapseEx12">
         <ul class="navbar-nav mr-auto smooth-scroll">
            ...
            <li class="nav-item">
               <a href="http://localhost:8000/#about" class="nav-link">About</a>
            </li>
            <li class="nav-item">
               <a href="http://localhost:8000/#skills" class="nav-link">Skills</a>
            </li>
            <li class="nav-item">
               <a href="http://localhost:8000/#projects" class="nav-link">Works</a>
            </li>
            <li class="nav-item">
